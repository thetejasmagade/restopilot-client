...
const badgeStyles: any = {
  ...
  pickup: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300",
};
...
<template>
  ...
  >
    <table class="order-table min-w-full bg-white dark:bg-[#18181B] table-fixed">
            ...
            <Popover>
              <PopoverTrigger>
                <div class="flex items-center justify-start gap-1">
                  ...
                  <img
                    v-if="row.customer_info.mobile_no || row.customer_info.name"
